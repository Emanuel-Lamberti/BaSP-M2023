...
var count = 0;
for (var i = 0; i < newArray.length; i++) {
        var charMayus = newArray[i].valueOf().charAt().toUpperCase();
        var charMinus = newArray[i].valueOf().slice(1).toLowerCase();
        var stringComplete = charMayus + charMinus;
        alert(stringComplete);
}
...
console.log("La cadena llena es: " + emptyArray);